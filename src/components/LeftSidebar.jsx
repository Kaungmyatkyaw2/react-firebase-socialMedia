...
const LeftSidebar = () => {
  ...
  return (
    <div className={`md:w-[25%] h-[100vh] md:fixed fixed md:left-0 sm:w-[80%] w-full pt-[10px] md:bg-[#F0F2F5] bg-white z-[999] duration-500 ${toggle ? 'left-0' : 'left-[-100%]'}`}>
     

     <div className='pl-[10px] border-b border-gray-300 pb-[10px]'>

          <div className='flex items-center space-x-[10px] hover:bg-gray-200 py-[10px] px-[10px] rounded-[5px] cursor-pointer' onClick={() => nav(`/main/profile/${user?.id}`)}>
              <img src={user?.photoUrl} className='rounded-full h-[36px] w-[36px] object-cover' alt="" />
